...
export const homeTranslations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    // Principles
    'principles.banner': 'Consiga um emprego em tech ou seu dinheiro de volta',
    ...
    'events.image.desc3': 'Brainstorm durante uma hackthon de AI na França 🇫🇷.',
    'events.image.desc4':
    ...
    'footer.links.howItWorks': 'Como funciona a Borderless',
    'footer.links.privacy': 'Política de Privacidade',
    'footer.links.refund': 'Política de Reembolso',
  },
  en: {
    // Header
    'nav.tech': 'Tech',
    ...
    'recruitment.subtitle': 'Full-stack, ML Engineer, GoLang Dev and much more',
