  ...
  return (
    <section className="py-[10svh] space-y-12">
      <div className="space-y-6">
        ...
        >
          Ready to Take Your{" "}
          <span className="font-ivy text-secondary">Tech Career Global?</span>
        </AnimatedText>
        ...
        <div className="space-y-12">
          ...
          >
            Borderless Coding has already helped 100+ Brazilian developers land
            international jobs paying $10K+ USD/month. You could be next.
          </AnimatedText>
        </div>
